...
#include "synth.h"
// WaveFinder portability: this data-only header does not require Dexed/JUCE.
#include <stdio.h>
#include <string.h>
...
public:
    ...
    Controllers() {
        ...
        values_[kControllerPitch] = 8192;
        values_[kControllerPitchRangeUp] = 12;
        values_[kControllerPitchRangeDn] = 12;
        aftertouch_cc = breath_cc = foot_cc = modwheel_cc = 0;
        portamento_enable_cc = portamento_gliss_cc = false;
        portamento_cc = masterTune = 0;
        core = nullptr;
        amp_mod = 0;
        pitch_mod = 0;
        eg_mod = 0;
